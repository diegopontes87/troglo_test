...
class LoginWithEmailUsecase implements BaseFutureUsecase<UserCredentialsEntity, Result<AppFirebaseEmailAuthException, bool>> {
  ...
  Future<Result<AppFirebaseEmailAuthException, bool>> call(UserCredentialsEntity userInfo) async {
    return await _repository.loginWithEmail(userInfo);
  }
}
